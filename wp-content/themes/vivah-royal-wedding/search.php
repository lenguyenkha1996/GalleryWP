...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','vivah-royal-wedding'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'vivah-royal-wedding' ); ?></h1>
		<?php endif; ?>
	</header>
	...
	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php
			    $layout_option = get_theme_mod( 'vivah_royal_wedding_theme_options',__( 'Right Sidebar','vivah-royal-wedding' ) );
				        ...
				        <div id="" class="content_area col-md-8 col-sm-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vivah-royal-wedding' ); ?></p>
									<?php
										get_search_form();
								...
								<div class="navigation">
					                <?php
					                    ...
					                    the_posts_pagination( array(
					                        'prev_text'          => __( 'Previous page', 'vivah-royal-wedding' ),
					                        'next_text'          => __( 'Next page', 'vivah-royal-wedding' ),
					                        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vivah-royal-wedding' ) . ' </span>',
					                    ) );
					                ?>
