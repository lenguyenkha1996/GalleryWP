					    	...
					    	<section id="post_section">
								...
								while ( have_posts() ) : the_post();
									...
									the_post_navigation( array(
										'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'vivah-royal-wedding' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'vivah-royal-wedding' ) . '</span>',
										'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'vivah-royal-wedding' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'vivah-royal-wedding' ) . '</span> ',
									) );
