...
// Theme Activation Notice
	...
	add_action( 'admin_notices', 'vw_wedding_activation_notice' );
	}
...
function vw_wedding_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-wedding' ) .'</h3>';
	echo '<p>'. esc_html__( 'Thank you for choosing VW Wedding Theme. Would like to have you on our Welcome page so that you can reap all the benefits of our VW Wedding Theme.', 'vw-wedding' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_wedding_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-wedding' ) .'</a></p>';
	echo '</div>';
}
...
//define
define('VW_WEDDING_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-wedding/','vw-wedding');
define('VW_WEDDING_SUPPORT','https://wordpress.org/support/theme/vw-wedding/','vw-wedding');
define('VW_WEDDING_REVIEW','https://wordpress.org/support/theme/vw-wedding/reviews/','vw-wedding');
define('VW_WEDDING_BUY_NOW','https://www.vwthemes.com/themes/wordpress-wedding-theme/','vw-wedding');
define('VW_WEDDING_LIVE_DEMO','https://www.vwthemes.net/vw-wedding-pro/','vw-wedding');
define('VW_WEDDING_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-wedding-pro/','vw-wedding');
define('VW_WEDDING_FAQ','https://www.vwthemes.com/faqs/','vw-wedding');
define('VW_WEDDING_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-wedding');
define('VW_WEDDING_CONTACT','https://wordpress.org/support/theme/vw-wedding/','vw-wedding');
define('VW_WEDDING_CREDIT','https://www.vwthemes.com/themes/free-wordpress-wedding-theme/','vw-wedding');
if ( ! function_exists( 'vw_wedding_credit' ) ) {
	function vw_wedding_credit(){
		echo "<a href=".esc_url(VW_WEDDING_CREDIT)." target='_blank'>".esc_html__('Wedding WordPress Theme.','vw-wedding')."</a>";
	}
}

// Change number or products per row to 3
add_filter('loop_shop_columns', 'vw_wedding_loop_columns');
	if (!function_exists('vw_wedding_loop_columns')) {
	function vw_wedding_loop_columns() {
